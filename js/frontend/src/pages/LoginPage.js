...
export default function LoginPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      notify(`got: ${res.data.data.a} ${res.data.data.b}`, NOTIFY_TYPES.success)
    } catch (error) {
      if (error.message === user_service.DB_ERROR_CODES.nouser) notify("user not found", NOTIFY_TYPES.error)
